...
class _CartPageState extends State<CartPage> {
  ...
  void _incrementItem(Picture device) {
    setState(() {
      itemCounts[device] = (itemCounts[device] ?? 0) + 1;
    });
  }

  void _decrementItem(Picture device) {
    setState(() {
  ...
  void _removeItem(Picture device) {
    setState(() {
      itemCounts.remove(device);
    });
  }
                ...
                Expanded(
                  child: ListView.separated(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      Picture device = itemCounts.keys.elementAt(index);
                      return Slidable(
